...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            #[unstable]
            icu::datetime::provider::range_patterns::DatetimePatternsRangeGlueV1: DatetimePatternsRangeGlueV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeTimeV1: DatetimePatternsRangeTimeV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateBuddhistV1: DatetimePatternsRangeDateBuddhistV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateChineseV1: DatetimePatternsRangeDateChineseV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateCopticV1: DatetimePatternsRangeDateCopticV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateDangiV1: DatetimePatternsRangeDateDangiV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateEthiopianV1: DatetimePatternsRangeDateEthiopianV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateGregorianV1: DatetimePatternsRangeDateGregorianV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateHebrewV1: DatetimePatternsRangeDateHebrewV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateIndianV1: DatetimePatternsRangeDateIndianV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateHijriV1: DatetimePatternsRangeDateHijriV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateJapaneseV1: DatetimePatternsRangeDateJapaneseV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDatePersianV1: DatetimePatternsRangeDatePersianV1,
            icu::datetime::provider::range_patterns::DatetimePatternsRangeDateRocV1: DatetimePatternsRangeDateRocV1,
            ...
            icu::experimental::displaynames::provider::LocaleNamesRegionMediumV1: LocaleNamesRegionMediumV1,
            icu::experimental::displaynames::provider::LocaleNamesRegionShortV1: LocaleNamesRegionShortV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMediumV1: LocaleNamesLanguageMediumV1,
            ...
            icu::experimental::displaynames::provider::LocaleNamesLanguageMenuMediumV1: LocaleNamesLanguageMenuMediumV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptMediumV1: LocaleNamesScriptMediumV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptShortV1: LocaleNamesScriptShortV1,
            icu::experimental::displaynames::provider::LocaleNamesVariantMediumV1: LocaleNamesVariantMediumV1,
            icu::experimental::displaynames::provider::LocaleNamesEssentialsV1: LocaleNamesEssentialsV1,
